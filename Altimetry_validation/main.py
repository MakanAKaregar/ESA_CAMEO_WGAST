...
"""
===============================================================================
CAMEO-WGAST PROJECT - ALTIMETRY VALIDATION PIPELINE
===============================================================================

This script belongs to the CAMEO-WGAST project and focuses on extracting
river water level time series (SSH) from satellite altimetry missions
(Sentinel-3 / Sentinel-6).

OBJECTIVE:
----------
Generate validated SSH time series at RPR (River Reference Point) stations
using satellite altimetry, GNSS-IR observations, and in-situ hydrometric data.

MAIN FEATURES:
--------------
- Sentinel-3 / Sentinel-6 L2 processing
- River mask filtering
- Virtual station selection
- Misfit-based quality control
- SWORD river reaches integration (slope correction)
- Robust aggregation (median + MAD)
- Optional dam exclusion zone
- Cross-validation with GNSS-IR and in-situ gauges

OUTPUT:
-------
CSV files containing SSH time series per station and per satellite tract.
